...
from howl_editor.models import HowlFile, SpuAddrEntry, OtherFX, EngineFX, CseqInstrument, CseqPercussion
from tests.conftest import build_bank_blob, build_cseq_bytes


def _lookup():
    return SampleLookup(BankReader(), CseqReader(VlqCodec()))
...
class TestCollectSongSamples:
    ...
    def test_collects_instrument_samples(self):
        ...
        cseq = CseqReader(VlqCodec()).read(cseq_data)
